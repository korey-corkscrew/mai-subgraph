...
export class LinkVaultApproval extends ethereum.Event {
  get params(): LinkVaultApproval__Params {
    return new LinkVaultApproval__Params(this);
  }
}

export class LinkVaultApproval__Params {
  _event: LinkVaultApproval;

  constructor(event: LinkVaultApproval) {
    this._event = event;
  }
...
export class LinkVaultApprovalForAll extends ethereum.Event {
  get params(): LinkVaultApprovalForAll__Params {
    return new LinkVaultApprovalForAll__Params(this);
  }
}

export class LinkVaultApprovalForAll__Params {
  _event: LinkVaultApprovalForAll;

  constructor(event: LinkVaultApprovalForAll) {
    this._event = event;
  }
...
export class LinkVaultBorrowToken extends ethereum.Event {
  get params(): LinkVaultBorrowToken__Params {
    return new LinkVaultBorrowToken__Params(this);
  }
}

export class LinkVaultBorrowToken__Params {
  _event: LinkVaultBorrowToken;

  constructor(event: LinkVaultBorrowToken) {
    this._event = event;
  }
...
export class LinkVaultCreateVault extends ethereum.Event {
  get params(): LinkVaultCreateVault__Params {
    return new LinkVaultCreateVault__Params(this);
  }
}

export class LinkVaultCreateVault__Params {
  _event: LinkVaultCreateVault;

  constructor(event: LinkVaultCreateVault) {
    this._event = event;
  }
...
export class LinkVaultDepositCollateral extends ethereum.Event {
  get params(): LinkVaultDepositCollateral__Params {
    return new LinkVaultDepositCollateral__Params(this);
  }
}

export class LinkVaultDepositCollateral__Params {
  _event: LinkVaultDepositCollateral;

  constructor(event: LinkVaultDepositCollateral) {
    this._event = event;
  }
...
export class LinkVaultDestroyVault extends ethereum.Event {
  get params(): LinkVaultDestroyVault__Params {
    return new LinkVaultDestroyVault__Params(this);
  }
}

export class LinkVaultDestroyVault__Params {
  _event: LinkVaultDestroyVault;

  constructor(event: LinkVaultDestroyVault) {
    this._event = event;
  }
...
export class LinkVaultLiquidateVault extends ethereum.Event {
  get params(): LinkVaultLiquidateVault__Params {
    return new LinkVaultLiquidateVault__Params(this);
  }
}

export class LinkVaultLiquidateVault__Params {
  _event: LinkVaultLiquidateVault;

  constructor(event: LinkVaultLiquidateVault) {
    this._event = event;
  }
...
export class LinkVaultOwnershipTransferred extends ethereum.Event {
  get params(): LinkVaultOwnershipTransferred__Params {
    return new LinkVaultOwnershipTransferred__Params(this);
  }
}

export class LinkVaultOwnershipTransferred__Params {
  _event: LinkVaultOwnershipTransferred;

  constructor(event: LinkVaultOwnershipTransferred) {
    this._event = event;
  }
...
export class LinkVaultPayBackToken extends ethereum.Event {
  get params(): LinkVaultPayBackToken__Params {
    return new LinkVaultPayBackToken__Params(this);
  }
}

export class LinkVaultPayBackToken__Params {
  _event: LinkVaultPayBackToken;

  constructor(event: LinkVaultPayBackToken) {
    this._event = event;
  }
...
export class LinkVaultTransfer extends ethereum.Event {
  get params(): LinkVaultTransfer__Params {
    return new LinkVaultTransfer__Params(this);
  }
}

export class LinkVaultTransfer__Params {
  _event: LinkVaultTransfer;

  constructor(event: LinkVaultTransfer) {
    this._event = event;
  }
...
export class LinkVaultTransferVault extends ethereum.Event {
  get params(): LinkVaultTransferVault__Params {
    return new LinkVaultTransferVault__Params(this);
  }
}

export class LinkVaultTransferVault__Params {
  _event: LinkVaultTransferVault;

  constructor(event: LinkVaultTransferVault) {
    this._event = event;
  }
...
export class LinkVaultWithdrawCollateral extends ethereum.Event {
  get params(): LinkVaultWithdrawCollateral__Params {
    return new LinkVaultWithdrawCollateral__Params(this);
  }
}

export class LinkVaultWithdrawCollateral__Params {
  _event: LinkVaultWithdrawCollateral;

  constructor(event: LinkVaultWithdrawCollateral) {
    this._event = event;
  }
...
export class LinkVault extends ethereum.SmartContract {
  ...
  _meta(): Address {
    let result = super.call("_meta", "_meta():(address)", []);

    return result[0].toAddress();
  }

  try__meta(): ethereum.CallResult<Address> {
    let result = super.tryCall("_meta", "_meta():(address)", []);
    if (result.reverted) {
  ...
  base(): string {
    let result = super.call("base", "base():(string)", []);

    return result[0].toString();
  }

  try_base(): ethereum.CallResult<string> {
    let result = super.tryCall("base", "base():(string)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  try_collateralDecimals(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "collateralDecimals",
      "collateralDecimals():(uint256)",
      []
...
export class TransferToken1Call extends ethereum.Call {
  get inputs(): TransferToken1Call__Inputs {
    return new TransferToken1Call__Inputs(this);
  }

  get outputs(): TransferToken1Call__Outputs {
    return new TransferToken1Call__Outputs(this);
  }
}

export class TransferToken1Call__Inputs {
  _call: TransferToken1Call;

  constructor(call: TransferToken1Call) {
    this._call = call;
  }
...
export class TransferToken1Call__Outputs {
  _call: TransferToken1Call;
